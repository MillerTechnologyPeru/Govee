...
public extension MockAdvertisementData {
    ...
    static let goveeThermometer = MockAdvertisementData(
        localName: "GVH5072_7A27",
        manufacturerData: ManufacturerSpecificData(companyIdentifier: .govee, additionalData: Data([0, 3, 70, 146, 100, 0, 76, 0, 2, 21, 73, 78, 84, 69, 76, 76, 73, 95, 82, 79, 67, 75, 83, 95, 72, 87, 80, 114, 242, 255, 194])),
        txPowerLevel: nil,
        serviceData: nil,
        serviceUUIDs: [.bit16(0xEC88)],
        solicitedServiceUUIDs: nil
    )
}
...
public extension GoveeAdvertisement.Thermometer {
    ...
    static var mock: GoveeAdvertisement.Thermometer {
        return .init(MockAdvertisementData.goveeThermometer)!
    }
}
